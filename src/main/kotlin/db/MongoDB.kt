...
import dev.gangster.game.data.collection.PlayerCounter
import dev.gangster.game.data.collection.PlayerData
import dev.gangster.game.data.collection.model.ServerMetadata
...
class MongoDB(db: MongoDatabase) : Database {
    ...
    private suspend fun nextPlayerId(startAt: Int = 10): Int {
        return runMongoCatching {
            ...
            val doc = if (existing == null) {
                ...
                counter.insertOne(PlayerCounter(_id = "playerCounter", seq = startAt))
                PlayerCounter(_id = "playerCounter", seq = startAt)
            } else {
    ...
    override suspend fun createPlayer(
        ...
        return runMongoCatching {
            ...
            val dat = PlayerData.newGame(pid, username, email, avatarData)
