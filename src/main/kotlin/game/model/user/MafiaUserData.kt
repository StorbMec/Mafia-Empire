...
data class MafiaUserData(
    ...
    companion object {
        ...
        /**
         * TO-DO need game XP table
         */
        fun newGame(characterClass: PBCharacterClass): MafiaUserData {
            val defense = when (characterClass) {
                PBCharacterClassConstants.BULLY -> {
                    50
                }

                PBCharacterClassConstants.ROGUE -> {
                    25
                }

                PBCharacterClassConstants.TACTICIAN -> {
                    10
                }

                else -> {
                    throw IllegalArgumentException("Wrong characterClass: $characterClass")
                }
            }
